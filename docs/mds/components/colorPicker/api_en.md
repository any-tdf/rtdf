...
| onchange | `(colors: string[]) => void` | colors - Color values array       | Triggered when color changes. Lowercase event alias compatible with STDF. |
| onClose  | `(colors: string[]) => void` | colors - Color values array       | Triggered when popup closed.                  |
| onclose | `(colors: string[]) => void` | colors - Color values array       | Triggered when popup closed. Lowercase event alias compatible with STDF. |
| onCopy   | `(text: string) => void`     | text - Copied text                         | Triggered when copied.                        |
| oncopy | `(text: string) => void`     | text - Copied text                         | Triggered when copied. Lowercase event alias compatible with STDF. |
