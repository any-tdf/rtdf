...
| loading         | [`Loading`](/components?nav=loading&tab=1) | `{}`    | N    | 异步状态时，Loading 参数。                     |
...
| onchange | `{ value: number }` | value - 当前值 | 当前值。 兼容 STDF 的小写事件别名。 |
| onDecrease | `() => void`        | -              | 点击减少时触发。 |
| ondecrease | `() => void`        | -              | 点击减少时触发。 兼容 STDF 的小写事件别名。 |
| onIncrease | `() => void`        | -              | 点击增加时触发。 |
| onincrease | `() => void`        | -              | 点击增加时触发。 兼容 STDF 的小写事件别名。 |
