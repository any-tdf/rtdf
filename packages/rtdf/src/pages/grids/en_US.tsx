...
function GridsEn() {
	...
	return (
		<>
			<div className='mt-8 px-4 font-bold'>Using Placeholder Example 3﹡4</div>
			<Grids cols='4'>
				<Grid row='3'>
			...
			<div className='mt-8 px-4 font-bold'>Using Placeholder Example 4﹡6</div>
			<Grids>
				<Grid row='3' col='2'>
			...
			<div className='mt-8 px-4 font-bold'>Increase Margin and Cell Gap</div>
			...
			<div className='mt-8 px-4 font-bold'>Scene Example 6﹡5</div>
							...
							<div className='flex h-full justify-around rounded-lg bg-white p-1 py-1 text-center text-xs shadow-sm dark:bg-black dark:shadow-white/10'>
								...
								<div className='flex flex-col justify-around'>
									<div className='text-sm'>
										...
										{currentDevice === 'Android' && 'Snapdragon'}
