...
export default function SkeletonPage() {
	return (
		<div className='p-2'>
			<div className='m-4 text-lg font-bold'>脉冲效果 (pulse)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>波浪效果 (wave)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>无动画 (none)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>呼吸效果 (breathe)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>灰色背景 (gray)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>主题色背景 (theme)</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>示例 1</div>
			...
			<div className='m-4 text-lg font-bold'>示例 3</div>
			<div className='flex'>
			...
			<div className='m-4 text-lg font-bold'>示例 4</div>
			<div className='flex'>
				<div className='grow'>
					<Skeleton width='32' height='8' />
					<Skeleton type='p' />
			...
			<div className='m-4 text-lg font-bold'>示例 5</div>
			...
			<div className='m-4 text-lg font-bold'>示例 6</div>
