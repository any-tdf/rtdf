...
import { Grids, Grid, Placeholder } from '../components/index';
import { Switch, Icon, Button } from '../components/index';
...
export default function GridsDemo() {
	...
	const { month, day, weekDay } = timeInfo;
