...
| easeType           | `EasingProps`                                                                    | `'cubicOut'` | N    | 出现动画，共 31 个值，RTDF 内置 easing 函数集。 |
| easeOutType        | `EasingProps`                                                                    | `'cubicOut'` | N    | 退出动画，共 31 个值，RTDF 内置 easing 函数集。 |
...
| onclickMask | `() => void` | -    | 点击弹出层遮罩时触发，即使 maskClosable 为 false 也会触发。 兼容 STDF 的小写事件别名。 |
| onClose     | `() => void` | -    | 弹出层关闭时触发。                                          |
| onclose | `() => void` | -    | 弹出层关闭时触发。 兼容 STDF 的小写事件别名。 |

## Popup Children

| 名称     | 类型                                                                | 参数 | 说明         |
| -------- | ------------------------------------------------------------------- | ---- | ------------ |
| children | ReactNode | -    | Popup 内容。 |
