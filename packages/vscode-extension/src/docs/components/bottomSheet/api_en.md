...
| onclose | `() => void`               | -                       | Triggered when popup closes. Lowercase event alias compatible with STDF. |
| onClickMask    | `() => void`               | -                       | Triggered when clicking mask, even if maskClosable is false. |
| onclickMask | `() => void`               | -                       | Triggered when clicking mask, even if maskClosable is false. Lowercase event alias compatible with STDF. |
| onBack         | `() => void`               | -                       | Triggered when clicking left back icon.                      |
| onback | `() => void`               | -                       | Triggered when clicking left back icon. Lowercase event alias compatible with STDF. |
| onHeightChange | `(height: number) => void` | height - Current height | Triggered when sliding ends.                                 |
| onheightChange | `(height: number) => void` | height - Current height | Triggered when sliding ends. Lowercase event alias compatible with STDF. |
