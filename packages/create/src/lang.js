...
export const en_US = {
    ...
    tgs: 'To get started:',
    pcyt_vt: 'Tip: please configure Initial Color System in src/index.css, reference https://rtdf.dev/guide/theme',
    pcyt_vu: 'Tip: please configure Initial Color System in src/index.css and UnoCSS tokens in uno.config.ts, reference https://rtdf.dev/guide/theme',
    ...
    tms: 'Initial theme (ANYTDF), add custom themes later',
    ...
    iconIconifyHint: 'Use Iconify icon sets with Tailwind CSS or UnoCSS (https://iconify.design)',
    iconBothHint: 'Use both SVG symbol sprites and Iconify',
    iconNoneHint: 'No icon solution, configure manually later',
    themeGeneratorHint: 'You can generate custom themes at https://rtdf.dev/guide/generator',
};
...
export const zh_CN = {
    ...
    pcsucc: '项目创建成功！',
    tgs: '开始：',
    pcyt_vt: '提示：请到 src/index.css 配置初始主题色，参考 https://rtdf.dev/guide/theme',
    pcyt_vu: '提示：请到 src/index.css 配置初始主题色，并在 uno.config.ts 同步 UnoCSS token，参考 https://rtdf.dev/guide/theme',
    cferror: '创建文件失败',
    pectn: '请输入正确的模板名称！',
    pic: '请输入正确的图标使用方式！',
    ptm: '请输入正确的主题模式！',
    tms: '初始 ANYTDF 主题，后续可增加自定义主题',
    tmm: '内置 3 个主题',
    tma: '全部 42 个内置主题',
    iconSvgSymbolHint: 'SVG symbol 雪碧图 Vite 插件（https://github.com/any-tdf/vite-plugin-svg-symbol）',
    iconIconifyHint: '配合 Tailwind CSS 或 UnoCSS 使用 Iconify 图标集（https://iconify.design）',
    iconBothHint: '同时使用 SVG symbol 雪碧图和 Iconify',
    iconNoneHint: '不用处理图标，或后续配置',
    themeGeneratorHint: '可到 https://rtdf.dev/guide/generator 配置生成自定义主题',
};
...
export const zh_TW = {
    ...
    pcsucc: '項目創建成功！',
    tgs: '開始：',
    pcyt_vt: '提示：請到 src/index.css 配置初始主題色，參考 https://rtdf.dev/guide/theme',
    pcyt_vu: '提示：請到 src/index.css 配置初始主題色，並在 uno.config.ts 同步 UnoCSS token，參考 https://rtdf.dev/guide/theme',
    cferror: '創建文件失敗',
    pectn: '請輸入正確的模板名稱！',
    pic: '請輸入正確的圖標使用方式！',
    ptm: '請輸入正確的主題模式！',
    tms: '初始 ANYTDF 主題，後續可增加自定義主題',
    tmm: '內置 3 個主題',
    tma: '全部 42 個內置主題',
    iconSvgSymbolHint: 'SVG symbol 雪碧圖 Vite 插件（https://github.com/any-tdf/vite-plugin-svg-symbol）',
    iconIconifyHint: '配合 Tailwind CSS 或 UnoCSS 使用 Iconify 圖標集（https://iconify.design）',
    iconBothHint: '同時使用 SVG symbol 雪碧圖和 Iconify',
    iconNoneHint: '不使用圖標方案，稍後手動配置',
    themeGeneratorHint: '可到 https://rtdf.dev/guide/generator 配置生成自定義主題',
};
...
export const ja_JP = {
    ...
    tgs: '開始：',
    pcyt_vt: 'ヒント：src/index.css ファイルで初期カラーシステムを設定し、参考 https://rtdf.dev/guide/theme',
    pcyt_vu: 'ヒント：src/index.css と uno.config.ts で初期カラーシステムを設定し、参考 https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: 'Tailwind CSS または UnoCSS で Iconify アイコンセットを使用（https://iconify.design）',
    iconBothHint: 'SVG シンボルスプライトと Iconify の両方を使用',
    iconNoneHint: 'アイコンソリューションなし、後で手動設定',
    themeGeneratorHint: 'https://rtdf.dev/guide/generator でカスタムテーマを生成できます',
};
...
export const ko_KR = {
    ...
    tgs: '시작：',
    pcyt_vt: '팁: src/index.css 파일에서 초기 색상 시스템을 구성하고 참조 https://rtdf.dev/guide/theme',
    pcyt_vu: '팁: src/index.css 및 uno.config.ts 파일에서 초기 색상 시스템을 구성하고 참조 https://rtdf.dev/guide/theme',
    cferror: '파일 생성 실패',
    ...
    iconIconifyHint: 'Tailwind CSS 또는 UnoCSS 와 함께 Iconify 아이콘 세트 사용 (https://iconify.design)',
    iconBothHint: 'SVG 심볼 스프라이트와 Iconify 모두 사용',
    iconNoneHint: '아이콘 솔루션 없음, 나중에 수동 구성',
    themeGeneratorHint: 'https://rtdf.dev/guide/generator 에서 사용자 정의 테마를 생성할 수 있습니다',
};
...
export const es_ES = {
    ...
    tgs: 'Para empezar:',
    pcyt_vt: 'Consejo: configure su sistema de colores en reference https://rtdf.dev/guide/theme',
    pcyt_vu: 'Consejo: configure su sistema de colores en src/index.css y uno.config.ts, reference https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: 'Usar conjuntos de iconos Iconify con Tailwind CSS o UnoCSS (https://iconify.design)',
    ...
    themeGeneratorHint: 'Puede generar temas personalizados en https://rtdf.dev/guide/generator',
};
...
export const ru_RU = {
    ...
    tgs: 'Чтобы начать:',
    pcyt_vt: 'Совет: настройте свой цветовой систему в ссылке https://rtdf.dev/guide/theme',
    pcyt_vu: 'Совет: настройте цветовую систему в src/index.css и uno.config.ts, ссылка https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: 'Использовать наборы иконок Iconify с Tailwind CSS или UnoCSS (https://iconify.design)',
    ...
    themeGeneratorHint: 'Вы можете создать пользовательские темы на https://rtdf.dev/guide/generator',
};
...
export const fr_FR = {
    ...
    tgs: 'Pour commencer:',
    pcyt_vt: 'Conseil: veuillez configurer votre système de couleurs dans reference https://rtdf.dev/guide/theme',
    pcyt_vu: 'Conseil: veuillez configurer votre système de couleurs dans src/index.css et uno.config.ts, reference https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: "Utiliser les ensembles d'icônes Iconify avec Tailwind CSS ou UnoCSS (https://iconify.design)",
    ...
    themeGeneratorHint: 'Vous pouvez générer des thèmes personnalisés sur https://rtdf.dev/guide/generator',
};
...
export const de_DE = {
    ...
    tgs: 'Um zu beginnen:',
    pcyt_vt: 'Tip: please configure your color system in reference https://rtdf.dev/guide/theme',
    pcyt_vu: 'Tip: please configure your color system in src/index.css and uno.config.ts, reference https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: 'Iconify-Icon-Sets mit Tailwind CSS oder UnoCSS verwenden (https://iconify.design)',
    ...
    themeGeneratorHint: 'Sie können benutzerdefinierte Themen unter https://rtdf.dev/guide/generator erstellen',
};
...
export const it_IT = {
    ...
    tgs: 'Per iniziare:',
    pcyt_vt: 'Consiglio: configura il tuo sistema di colori in https://rtdf.dev/guide/theme',
    pcyt_vu: 'Consiglio: configura il tuo sistema di colori in src/index.css e uno.config.ts, riferimento https://rtdf.dev/guide/theme',
    ...
    iconIconifyHint: 'Usa set di icone Iconify con Tailwind CSS o UnoCSS (https://iconify.design)',
    ...
    themeGeneratorHint: 'Puoi generare temi personalizzati su https://rtdf.dev/guide/generator',
};
