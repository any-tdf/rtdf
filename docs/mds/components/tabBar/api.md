...
| ---------- | --------------------------------------------------------- | ------ | ---- | ------------------ |
| text       | `string`                                                  | `''`   | N    | 选项卡文字。       |
| icon       | [`Icon`](/components?nav=icon&tab=1) | -      | N    | 选项卡图标。       |
| activeIcon | [`Icon`](/components?nav=icon&tab=1) | -      | N    | 激活的选项卡图标。 |
...
| onchange | `(active: number) => void` | `active` - 激活的 TabBar 索引值 | 点击 TabBar 时触发。 兼容 STDF 的小写事件别名。 |
