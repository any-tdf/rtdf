	...
	return (
		<>
			<div className='flex flex-col space-y-8 py-8'>
				...
				<div>
					<div className='p-4 font-bold'>不同边框风格</div>
				...
				<div>
					<div className='p-4 font-bold'>不同大小</div>
				...
				<div>
					<div className='p-4 font-bold'>固定大小</div>
				...
				<div>
					<div className='p-4 font-bold'>禁用</div>
				...
				<div>
					<div className='p-4 font-bold'>带图标</div>
				...
				<div>
					<div className='p-4 font-bold'>带加载（默认禁用）</div>
				...
				<div>
					<div className='p-4 font-bold'>带图标（通过 children 传入）</div>
					<Button>
				...
				<div>
					<div className='p-4 font-bold'>加载（通过 children 传入）</div>
					<Button>
				...
				<div>
					<div className='p-4 font-bold'>关爱版</div>
				...
				<div>
					<div className='p-4 font-bold'>自定义</div>
					<Button injClass='bg-error dark:bg-success'>纯色填充</Button>
					<Button injClass='bg-linear-to-r from-primary to-info dark:from-dark dark:to-info !text-white dark:!text-black'>渐变填充</Button>
