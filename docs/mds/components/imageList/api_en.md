...
| onadd | `(files: File[]) => void`                                | files: file list              | Triggered when files added. Lowercase event alias compatible with STDF. |
| onDelete    | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when deleted.           |
| ondelete | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when deleted. Lowercase event alias compatible with STDF. |
| onRetry     | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when retry.             |
| onretry | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when retry. Lowercase event alias compatible with STDF. |
| onPreview   | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when preview.           |
| onpreview | `(item: ImageListItemProps, index: number) => void`      | item: image, index            | Triggered when preview. Lowercase event alias compatible with STDF. |
| onExceed    | `(files: File[], max: number) => void`                   | files: file list, max: limit  | Triggered when count exceeded.    |
| onexceed | `(files: File[], max: number) => void`                   | files: file list, max: limit  | Triggered when count exceeded. Lowercase event alias compatible with STDF. |
| onOversized | `(file: File, maxSize: number) => void`                  | file: file, maxSize: limit    | Triggered when size exceeded.     |
| onoversized | `(file: File, maxSize: number) => void`                  | file: file, maxSize: limit    | Triggered when size exceeded. Lowercase event alias compatible with STDF. |
| onClickUpload | `() => void`                                           | -                             | Triggered when upload button clicked. |
| onclickUpload | `() => void`                                           | -                             | Triggered when upload button clicked. Lowercase event alias compatible with STDF. |
