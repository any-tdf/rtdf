...
| submitButton   | [`ButtonProps`](/components?nav=button&tab=1)                         | -         | N    | 提交按钮配置。                            |
| resetText      | `string`\|`null`                                                                         | `null`    | N    | 重置按钮文字，传入 null 时不显示。       |
| resetButton    | [`ButtonProps`](/components?nav=button&tab=1)                         | -         | N    | 重置按钮配置。                            |
| submitChildren | `ReactNode`                                                                                | -         | N    | 自定义提交按钮内容。                     |
| resetChildren  | `ReactNode`                                                                                | -         | N    | 自定义重置按钮内容。                     |
| space          | `'0'\|'1'\|'2'\|'4'\|'6'\|'8'`                                                           | `'0'`     | N    | 表单项垂直间距。                         |
| card           | `boolean`\|[`CardProps`](/components?nav=card&tab=1)                  | -         | N    | 是否使用 Card 组件包裹表单，传入对象时作为 Card 配置。 |
| mx             | `'2'\|'3'\|'4'\|'6'\|'8'`                                                                 | `'4'`     | N    | 卡片布局的水平外边距。                   |
| px             | `'0'\|'1'\|'2'\|'4'\|'6'`                                                                 | `'2'`     | N    | 卡片布局的水平内边距。                   |
| radius         | `'none'\|'xs'\|'sm'\|'md'\|'lg'\|'xl'\|'2xl'\|'full'\|''`                                | `''`      | N    | 卡片布局的圆角风格。                     |
| shadow         | `'none'\|'xs'\|'sm'\|'md'\|'lg'\|'xl'\|'2xl'`                                            | `'sm'`    | N    | 卡片布局的阴影风格。                     |
| onChange       | `(data: Record<string, FormValueProps>) => void`                                         | -         | N    | 表单项值变化时触发。                     |
| onchange | `(data: Record<string, FormValueProps>) => void`                                         | -         | N    | 表单项值变化时触发。 兼容 STDF 的小写事件别名。 |
| onSubmit       | `(data: Record<string, FormValueProps>) => void`                                         | -         | N    | 提交时触发。                             |
| onsubmit | `(data: Record<string, FormValueProps>) => void`                                         | -         | N    | 提交时触发。 兼容 STDF 的小写事件别名。 |
| onReset        | `() => void`                                                                             | -         | N    | 重置时触发。                             |
| onreset | `() => void`                                                                             | -         | N    | 重置时触发。 兼容 STDF 的小写事件别名。 |
...
| 名称           | 类型                                                                | 参数 | 说明                   |
| -------------- | ------------------------------------------------------------------- | ---- | ---------------------- |
| submitChildren | ReactNode | -    | 自定义提交按钮内容。   |
| resetChildren  | ReactNode | -    | 自定义重置按钮内容。   |
