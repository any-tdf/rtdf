...
| onclick | `(current: number) => void` | current - clicked index | Triggered when clicking container image. Lowercase event alias compatible with STDF. |
| onChange | `(current: number) => void` | current - current index | Triggered when active container changes. |
| onchange | `(current: number) => void` | current - current index | Triggered when active container changes. Lowercase event alias compatible with STDF. |
