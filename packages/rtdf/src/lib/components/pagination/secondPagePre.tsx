...
const SecondPagePre: React.FC<SecondPageProps> = ({ pageCol = 3, pages = [], maxShowPage = 7, radius = 'md', type = 'bold', bg = 'white', onClickItem }) => {
	...
	const secondPageState = resolvePaginationSecondPageDerived(resolvePaginationSecondPageStateOptions({
		props: { bg, maxShowPage, pageCol, pages, placement: 'pre' },
	}));
