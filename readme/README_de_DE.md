...
Mobile Web-Komponentenbibliothek auf Basis von [React](https://react.dev), [Tailwind CSS](https://tailwindcss.com) und dem any-tdf Designsystem.

> Ready | Tiny | Design | Fast

RTDF folgt dem Komponentendesign und der API-Form von STDF so genau, wie React es erlaubt. Svelte-spezifische Funktionen werden auf React props, React nodes, render functions und Provider-based configuration abgebildet.

# Funktionen

- Vollständige Unterstützung für React 18/19, Tailwind CSS v4 und TypeScript.
- Mobile-first Komponenten für allgemeine Controls, Layout, Navigation, Dateneingabe, Anzeige und Feedback.
- Umfangreiche APIs zur Konfiguration von Verhalten, Styling, Icons, Animationen und Interaktionen.
- Dark Mode, Theme-Wechsel zur Laufzeit, Generierung eigener Themes und 42 gemeinsame any-tdf Themes.
- Chinesische und englische Dokumentation, Komponentenbeispiele, API-Tabellen, FAQ und Versionshinweise.
- Internationalisierung mit mehr als 60 integrierten Locales.
- Subpath-Exports für Komponenten, Typen, Themes, Locales und Utilities.
- Scaffolding mit create-rtdf für Vite, React, Tailwind CSS v4, TypeScript, Icons und Theme-Presets.
- SVG Symbol tooling über @any-tdf/vite-plugin-svg-symbol und optionale Iconify-Unterstützung.
- VS Code Erweiterung und AI Skill Paket für effizientere RTDF-Entwicklung.
...
Besuche [demo.rtdf.dev](https://demo.rtdf.dev) oder scanne den QR-Code, um die mobile Demo zu öffnen.
...
Du kannst RTDF schnell in der [RTDF Demo](https://stackblitz.com/github/any-tdf/demo-rtdf) auf StackBlitz ausprobieren.

# Feedback und Kommunikation

Wir empfehlen [GitHub Issues](https://github.com/any-tdf/rtdf/issues) für direktes und effektives Feedback. Code-Beiträge sind ebenfalls sehr willkommen. Du kannst auch eine der folgenden Optionen wählen:
...
Dieses Projekt ist unter der MIT-Lizenz lizenziert. Nutze es frei und beteilige dich am Open-Source-Projekt.
