...
| oncancel | `() => void`                              | -                                               | Triggered when clicking cancel button. Lowercase event alias compatible with STDF. |
...
| onclickAction | `(index: number, action: Action) => void` | index - Click index; action - Click option data | Triggered when clicking an option, even if the option does not close. Lowercase event alias compatible with STDF. |
